...
#
# arty_audio.tcl: Tcl script for re-creating project 'arty_audio'
#
# Generated by Vivado on Thu Sep 09 21:18:18 EDT 2021
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hdl/axis_amplifier.sv"]"\
 "[file normalize "$origin_dir/hdl/led_magnitude_driver.vhd"]"\
 "[file normalize "$origin_dir/cores/ila_0/ila_0.xci"]"\
 "[file normalize "$origin_dir/cores/xadc_wiz_0/xadc_wiz_0.xci"]"\
 "[file normalize "$origin_dir/cores/ila_1/ila_1.xci"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/hdl/axis_i2s2.v"]"\
 "[file normalize "$origin_dir/hdl/axis_volume_controller.v"]"\
 "[file normalize "$origin_dir/hdl/top.v"]"\
 "[file normalize "$origin_dir/cores/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/phys/pin_constraints.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../dev_kits/pmod_i2s2/github/repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "arty_audio"
...
set script_file "arty_audio.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../dev_kits/pmod_i2s2/proj"]"
...
set_property -name "ip_output_repo" -value "/home/u0/Workspace/fpga/dev_kits/pmod_i2s2/github/repo/cache" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../dev_kits/pmod_i2s2/github/repo"]" $obj
...
set file "$origin_dir/hdl/axis_i2s2.v"
...
set file "$origin_dir/hdl/axis_volume_controller.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "hdl/axis_amplifier.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "hdl/led_magnitude_driver.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# set file "hdl/led_magnitude_driver_tb.vhd"
# set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
# set_property -name "file_type" -value "VHDL 2008" -objects $file_obj
# set_property -name "is_enabled" -value "1" -objects $file_obj
# set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "generic" -value "NUMBER_OF_SWITCHES=4 RESET_POLARITY=0" -objects $obj
...
set_property -name "vhdl_generic" -value "NUMBER_OF_SWITCHES=4 RESET_POLARITY=0" -objects $obj
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/cores/clk_wiz_0/clk_wiz_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "[file normalize ${origin_dir}/phys/pin_constraints.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/phys/pin_constraints.xdc"
set file [file normalize $file]
...
# # # Add local files from the original project (-no_copy_sources specified)
# # set files [list \
# #  [file normalize "${origin_dir}/../../../dev_kits/pmod_i2s2/proj/Pmod-I2S2-Arty-A7-35.sim/sim_1/tb_knob_ctrl_behav.wcfg" ]\
# # ]
...
# # set file "sim_1/tb_knob_ctrl_behav.wcfg"
...
# set_property -name "top" -value "led_magnitude_driver_tb" -objects $obj
# set_property -name "top_auto_set" -value "0" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "${origin_dir}/runs/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "${origin_dir}/runs/impl_1" -objects $obj
